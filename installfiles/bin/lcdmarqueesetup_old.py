...
os.system("sudo cp /home/pi/installfiles/bin/services/MarqueeBitLCD.service /etc/systemd/system/MarqueeBitLCD.service")
os.system("sudo cp /home/pi/installfiles/bin/services/MarqueeBitLCDImage.service /etc/systemd/system/MarqueeBitLCDImage.service")
...
os.system("sudo chmod 644 /etc/systemd/system/MarqueeBitLCD.service")
os.system("sudo chmod 644 /etc/systemd/system/MarqueeBitLCDImage.service")
